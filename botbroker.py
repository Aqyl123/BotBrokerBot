...
import tohru
import soleaio
from soleaio import soleL, soleR
...
token = 'NzAzMzI2OTcyNTE1NzEzMDc0.XxerzQ.3-9hAvPkS1IalStkg9C4Whq5Dcg'
...
`SWFT`\n• Discord unbindable upon request""", inline=False)
	...
	if message.content.startswith('!sole'):
		embed = discord.Embed(title="SoleAIO", url="https://www.botbroker.io/groups/soleaio", description='Last recorded sales for SoleAIO', color=0x22222F)
